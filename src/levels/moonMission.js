...
export function buildMoonMission() {
  ...
  return buildRaceCourse({
    ...
    terrainColor: 0x14233A, edgeColor: 0xFFD23F, gridColor: 0x2FAE6A,
    backdrop: 'moon',
    ...
    movers: [
      { z: L * 0.24, x0: -7, x1: 7, sp: 0.8, color: 0x4F8CFF },
      { z: L * 0.42, x0: 7, x1: -7, sp: 0.7, color: 0x5FCB88 },
      { z: L * 0.64, x0: -6, x1: 6, w: 3.5, d: 4, sp: 1.0, color: 0x4F8CFF },
      { z: L * 0.81, x0: 6, x1: -6, w: 3.5, d: 4, sp: 1.1, color: 0x5FCB88 },
    ],
    pendulums: [
