...
export function buildLiquidationLane() {
  ...
  return buildRaceCourse({
    ...
    terrainColor: 0x3A1208, edgeColor: 0xFF5151, gridColor: 0x2FAE6A,
    ...
    movers: [
      { z: L * 0.22, x0: -6, x1: 6, w: 3, d: 3.5, sp: 1.0, color: 0x5FCB88 },
      { z: L * 0.39, x0: 6, x1: -6, w: 3, d: 3.5, sp: 1.1, color: 0x5FCB88 },
      { z: L * 0.56, x0: -5, x1: 5, w: 3, d: 3.5, sp: 1.2, color: 0x5FCB88 },
      { z: L * 0.74, x0: 5, x1: -5, w: 3, d: 3.5, sp: 1.3, color: 0x5FCB88 },
      { z: L * 0.89, x0: -4, x1: 4, w: 3, d: 3.5, sp: 1.4, color: 0x5FCB88 },
    ],
